...
export default function Quiz() {
    return (
        <div
            ...
            <Image src={"/images/projects/quiz.jpeg"} width={224} height={0} alt="Image" className="w-56 shadow-md transform group-hover:scale-110 transition-transform duration-300 ease-in-out"/>
