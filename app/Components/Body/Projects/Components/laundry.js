...
export default function Laundry() {
    return (
        <div
            ...
            <Image src={"/images/projects/laundry.png"} width={224} height={0} className="w-56 shadow-md transform group-hover:scale-110 transition-transform duration-300 ease-in-out" />
