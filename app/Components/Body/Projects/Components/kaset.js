    ...
    return (
        <div className="bg-[#C80036] max-w-full grid justify-between text-center text-white p-8 overflow-hidden">
            ...
            <div className="flex justify-center group">
                <Image src={"/images/projects/kaset.png"} width={384} height={0} className="w-96 shadow-md transform group-hover:scale-110 transition-transform duration-300 ease-in-out" />
            </div>
